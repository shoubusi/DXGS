...
using DXGS.Common;
using DXGS.Main.Properties;
using DXGS.Main.ViewModels;
using DXGS.Main.Views;
using DXGS.Modules.ViewModels;
using DXGS.Modules.Views;
using System.ComponentModel;
using System.Windows;
using AppModules = DXGS.Common.Modules;
...
namespace DXGS.Main
{
    ...
    public class Bootstrapper
    {
        ...
        protected virtual void RegisterModules()
        {
            ...
            Manager.Register(Regions.Navigation, new Module(AppModules.Configuration, () => new NavigationItem("Configuration")));
            Manager.Register(Regions.Navigation, new Module(AppModules.Module2, () => new NavigationItem("Module2")));
            Manager.Register(Regions.Documents, new Module(AppModules.Configuration, () => ConfigurationViewModel.Create("Configuration"), typeof(ConfigurationView)));
        ...
        protected virtual void InjectModules()
        {
            ...
            Manager.Inject(Regions.Navigation, AppModules.Configuration);
